...
public class Instructions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("INSTRUCTIONS:\n\nEach player, one by one, will\nchoose to say either one number\nor two numbers in strictly\nincreasing order.\n\nThe player who is smart enough\nto stop at 20; wins, or in other\nwords the player who is forced to\n\"Say My Number\" i.e. 21 will lose.\n\nLet's see if you will\n\tSay My Number!\n\t\tor not?\t");
        jScrollPane2.setViewportView(jTextArea2);

        jButton1.setText("Okay! I am ready. Bring it on!!!");
